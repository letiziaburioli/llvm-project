...
foreach(_expectedTarget LLVMHello FileCheck llvm-PerfectShuffle count not UnicodeNameMappingGenerator yaml-bench split-file BugpointPasses lli-child-target llvm-jitlink-executor obj2yaml yaml2obj Bye TestPlugin DoublerPlugin)
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/lib/LLVMHello.so"
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/not"
  )
...
set_target_properties(UnicodeNameMappingGenerator PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/UnicodeNameMappingGenerator"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/yaml-bench"
  )
...
set_target_properties(split-file PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/split-file"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/bin/yaml2obj"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/lib/Bye.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
...
set_target_properties(DoublerPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_DEBUG ""
  IMPORTED_LOCATION_DEBUG "/home/letizia/llvm-project/unittests/Passes/DoublerPlugin.so"
  IMPORTED_NO_SONAME_DEBUG "TRUE"
  )
